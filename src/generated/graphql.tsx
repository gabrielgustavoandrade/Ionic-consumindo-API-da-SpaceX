 ...
 * });
 */
export function useLaunchesPastQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<LaunchesPastQuery, LaunchesPastQueryVariables>) {
        return ApolloReactHooks.useQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(LaunchesPastDocument, baseOptions);
      }
export function useLaunchesPastLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<LaunchesPastQuery, LaunchesPastQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(LaunchesPastDocument, baseOptions);
        }
